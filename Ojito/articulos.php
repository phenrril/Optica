                            ...
                            <table WIDTH="80%" class="table table-borderless" id="buscarcliente">
                                    ...
                                    <tr>
                                        ...
                                        <td><input   name="identificadorT" type="text"  ></td>
                                            ...
                                            <th scope="row"><input name="agregar_articulo" type="submit" class="btn btn-primary"Value="Agregar Articulo"></input></th>
                                            <th scope="row"><input name="listar_A" type="submit" class="btn btn-primary"Value="Listar Articulos"></input></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
